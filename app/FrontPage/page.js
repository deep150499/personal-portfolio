  ...
  return (
    <div className="mt-32">
      ...
      <div className="mt-6 max-w-3xl">
        ...
        <Link href={'https://drive.google.com/file/d/11mwOaCTn4moE6Z0LKi_fY3uAJH6x6J8L/view?usp=sharing'} target="_blank"><button className="mt-10 border border-neutral-700/30 rounded-md p-2 w-full lg:w-44 bg-neutral-800/20 text-sm dark:text-neutral-400 font-semibold">
          View resume
        </button>
        </Link>
      </div>
